...
def parallel_summarize_master(sc, streams, subjects,  mode,  master_file, parallelism="all", localtime=False):
    ...
    if(mode=="test"):
        ...
        # subjects = ["135c9c3b-a5cf-47a4-9fcf-4fc418c5eb96"]
        ...
        try:
            ...
            if field_index is None:
                ...
                if not stream in user_streams:  
                    ...
                    stream_ids = data_retriever.get_latest_stream_id(cc, sub, stream)
...
def get_subject_offset(subject):
    ...
    label_streams = [
        ...
        "org.md2k.data_qualtrics_ems.feature.sleep.d&value",
        "org.md2k.data_qualtrics_ems.feature.tob.quantity.d&value",
        "org.md2k.data_qualtrics.feature.stress.d&value"
